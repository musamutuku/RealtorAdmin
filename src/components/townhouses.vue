...
fetch('http://127.0.0.1:3000/api/data1').then(response => response.json())
.then(data => localStorage.setItem('townhouses', JSON.stringify(data)));

const townhouses = JSON.parse(localStorage.getItem('townhouses'))
...
<template>
    <div class="main-div">
        <div class="top-div">
            <span class="nav-title">Townhouses</span>
        ...
        <div class="center-div">
            <div class="allusers">
                <table>
                    ...
                    <tbody>
                        <tr v-for="house in townhouses" :key="house.id">
                            <td>{{ house.id }}</td>
