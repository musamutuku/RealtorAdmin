...
.then(data => localStorage.setItem('mobilehomes', JSON.stringify(data)));

const mobilehomes = JSON.parse(localStorage.getItem('mobilehomes'))
...
<template>
    <div class="main-div">
        <div class="top-div">
            <span class="nav-title">Mobilehomes</span>
        ...
        <div class="center-div">
            <div class="allusers">
                <table>
                    ...
                    <tbody>
                        <tr v-for="house in mobilehomes" :key="house.id">
                            <td>{{ house.id }}</td>
